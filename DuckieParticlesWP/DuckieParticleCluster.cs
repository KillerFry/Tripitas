...
namespace DuckieParticles {
    public class DuckieParticleCluster {
        ...
        public virtual void Draw(GameTime gameTime) {
            ParticleManager.SpriteBatch.Begin();
        ...
        public virtual void AddParticles(uint numberOfParticles) {
            ...
            for (uint i = 0; i < numberOfParticles; i++) {
                _particles.Add(new DuckieParticle() { ParticleCluster = this, ParticleManager = this.ParticleManager, Texture = ParticleManager.Textures["particle"] } );
            }
        }
